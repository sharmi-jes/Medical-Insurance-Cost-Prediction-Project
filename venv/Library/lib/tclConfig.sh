...
# installed.
TCL_PREFIX='D:/RESUME ML PROJECTS/Medical Insuarnce/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/RESUME ML PROJECTS/Medical Insuarnce/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/RESUME ML PROJECTS/Medical Insuarnce/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/RESUME ML PROJECTS/Medical Insuarnce/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/RESUME ML PROJECTS/Medical Insuarnce/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/RESUME ML PROJECTS/Medical Insuarnce/venv\Library\lib\tclstub86.lib'
